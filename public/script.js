...
case 'sora2':
    ...
    break;
        case 'sora2':
            message = `สวัสดีครับ! ผมคือ Sora 2 Prompt Master ✨<br><br>
                      ผมช่วยสร้าง <strong>Prompt ที่ดีที่สุด</strong> สำหรับสร้างวิดีโอด้วย Sora 2 จาก OpenAI<br><br>
                      💡 <strong>วิธีใช้:</strong> แค่บอกไอเดียฉากที่ต้องการเป็นภาษาไทย<br>
                      ✨ ผมจะแปลงให้เป็น Prompt ที่ละเอียด พร้อมเทคนิคการถ่ายทำระดับโปร
                      🎬 พร้อมใช้กับ Sora 2 ได้ทันที!<br><br>
                      🎯 <strong>Tip:</strong> ยิ่งบรรยายฉาก แสง สี การเคลื่อนไหว ละเอียดเท่าไหร่ ยิ่งได้วิดีโอสวยมากขึ้น!`;
            break;
    ...
    switch(mode) {
        ...
        case 'multichar':
            infoHTML = quickActionsHTML + `
                ...
                <p style="font-size: 13px; color: #a1a1aa;">
                    • รองรับ 1-5 ตัวละคร พร้อมบทพูด<br>
                    • เหมาะกับฉากซับซ้อน
                </p>
            `;
            break;
