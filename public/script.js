...
document.getElementById('characterLibrary').classList.remove('active');
    ...
    sendButton.innerHTML = 'สร้างฉากเต็ม 🎭';
...
function addWelcomeMessage(mode) {
    ...
    switch(mode) {
        case 'general':
            message = `สวัสดีครับ! ผมคือ Prompt Generator ผู้ช่วยสร้าง Prompt ระดับเทพ🎬<br><br>
        ...
        case 'multichar':
    message = `สวัสดีครับ! ผมคือ Prompt Master 🎭<br><br>
